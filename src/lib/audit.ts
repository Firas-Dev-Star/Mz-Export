...
export type AuditAction =
  ...
  | 'UPDATE_CARRIER'
  | 'DELETE_CARRIER'
  | 'CREATE_TRANSPORT_INVOICE'
  | 'UPDATE_TRANSPORT_INVOICE'
  | 'CONFIRM_TRANSPORT_INVOICE'
  | 'CANCEL_TRANSPORT_INVOICE'
  | 'DELETE_TRANSPORT_INVOICE'
  | 'LINK_TRANSPORT_INVOICE'
  | 'UNLINK_TRANSPORT_INVOICE'
  | 'CREATE_TRANSPORT_PAYMENT'
  | 'DELETE_TRANSPORT_PAYMENT'
  | 'ADJUST_STOCK'
  | 'CREATE_PAYMENT'
  | 'DELETE_PAYMENT'
  | 'CREATE_DOCUMENT'
