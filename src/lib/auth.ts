...
export const PERMISSIONS = {
  ...
  'carrier.read': ['ADMIN', 'MANAGER', 'USER'],
  'carrier.write': ['ADMIN', 'MANAGER'],
  'carrier.delete': ['ADMIN'],
  'transport.read': ['ADMIN', 'MANAGER', 'USER'],
  'transport.write': ['ADMIN', 'MANAGER'],
  'transport.confirm': ['ADMIN', 'MANAGER'],
  'transport.cancel': ['ADMIN', 'MANAGER'],
  'transport.delete': ['ADMIN'],
